...
/**
 * GeneralActivityManager is an abstract class that manages activities and their configurations.
 * @abstract
 */
class GeneralActivityManager {
    ...
    /**
     * This gets the location of the panel file.
     * @abstract
    ...
    /**
     * Handles the panel file content.
     * 
     * @param {*} panel 
     * @param {*} file 
     */
    ...
    /**
     * Updates the visibility of the activity in the activities menu.
     * 
     * @abstract
     * @param {*} activityid 
     * @param {*} visible 
    ...
    /**
     * Checks if the panel is generated by a tool.
     * 
     * @abstract
     * @param {*} panelId 
     */
